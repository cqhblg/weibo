...
import cats.Show
import com.neo.sk.todos2018.front.pages.{BlogAttention, BlogMain, BlogOther, Login, Register, Self, TaskList}
import mhtml.mount
  ...
  */
  ...
  val currentPage = currentHashVar.map { ls =>
    ...
    ls match {
      ...
      case "Blog" :: Nil => BlogMain.app
      case "Self"::Nil=>Self.app
      case "BlogAttention"::Nil=>BlogAttention.app
      case "BlogOther"::other::Nil=>BlogOther(other.toString()).app
